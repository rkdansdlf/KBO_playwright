"""Compatibility wrapper for src.cli.backfill.backfill_starting_pitchers_from_stats."""

from __future__ import annotations

import sys

from src.cli.backfill import backfill_starting_pitchers_from_stats as _target_module
