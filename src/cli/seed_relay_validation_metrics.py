"""Compatibility wrapper for src.cli.collection.seed_relay_validation_metrics."""

from __future__ import annotations

import sys

from src.cli.collection import seed_relay_validation_metrics as _target_module
