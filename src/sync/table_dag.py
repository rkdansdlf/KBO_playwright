...
TABLE_REGISTRY: list[TableMeta] = [
    ...
    TableMeta("team_code_map", level=0, strategy=SyncStrategy.SNAPSHOT, natural_keys=["legacy_code"]),
    TableMeta("team_franchises", level=0, strategy=SyncStrategy.SNAPSHOT, natural_keys=["franchise_id"]),
    TableMeta("team_history", level=0, strategy=SyncStrategy.SNAPSHOT, natural_keys=["history_id"]),
    TableMeta("teams", level=0, strategy=SyncStrategy.SNAPSHOT, natural_keys=["team_code"]),
    TableMeta("player_basic", level=0, strategy=SyncStrategy.INCREMENTAL, natural_keys=["player_id"]),
    TableMeta("players", level=0, strategy=SyncStrategy.INCREMENTAL, natural_keys=["player_id"]),
    ...
    TableMeta(
        ...
        natural_keys=["source_system", "source_game_id"],
    ),
    TableMeta(
        "game_metadata",
        level=1,
    ...
    TableMeta(
        "game_summary", level=1, strategy=SyncStrategy.INCREMENTAL, timestamp_col="updated_at", natural_keys=["game_id"]
    ),
    TableMeta(
        "player_season_batting",
        level=1,
        strategy=SyncStrategy.INCREMENTAL,
        natural_keys=["player_id", "season", "league", "level", "team_code"],
        omit_id=True,
    ),
    TableMeta(
    ...
    TableMeta("game_batting_stats", level=2, strategy=SyncStrategy.INCREMENTAL, natural_keys=["game_id", "player_id"]),
    TableMeta("game_pitching_stats", level=2, strategy=SyncStrategy.INCREMENTAL, natural_keys=["game_id", "player_id"]),
    TableMeta(
        "game_inning_scores",
        level=2,
        strategy=SyncStrategy.INCREMENTAL,
    ...
    TableMeta(
        ...
        natural_keys=["snapshot_id"],
    ),
    TableMeta("embedding_cache", level=3, strategy=SyncStrategy.INCREMENTAL, natural_keys=["cache_key"]),
