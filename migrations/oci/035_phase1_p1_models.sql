-- 035_phase1_p1_models.sql
-- OCI migration: Phase 1 (P1) - Stadium seat sections, parking lots, parking fee rules, food vendors, food menu items
...
CREATE TABLE IF NOT EXISTS stadium_seat_sections (
    ...
    is_home_cheering BOOLEAN NOT NULL DEFAULT FALSE,
    is_away_cheering BOOLEAN NOT NULL DEFAULT FALSE,
    is_table_seat BOOLEAN NOT NULL DEFAULT FALSE,
    is_family_seat BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS parking_lots (
    ...
    is_event_day_available BOOLEAN NOT NULL DEFAULT TRUE,
