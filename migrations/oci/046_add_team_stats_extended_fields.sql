...
ALTER TABLE team_season_batting ADD COLUMN iso DOUBLE PRECISION;
ALTER TABLE team_season_batting ADD COLUMN babip DOUBLE PRECISION;
...
ALTER TABLE team_season_pitching ADD COLUMN k_per_nine DOUBLE PRECISION;
ALTER TABLE team_season_pitching ADD COLUMN bb_per_nine DOUBLE PRECISION;
ALTER TABLE team_season_pitching ADD COLUMN kbb DOUBLE PRECISION;
ALTER TABLE team_season_pitching ADD COLUMN fip DOUBLE PRECISION;
