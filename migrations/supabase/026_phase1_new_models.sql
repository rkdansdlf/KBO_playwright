...
CREATE TABLE IF NOT EXISTS game_mvps (
    id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    game_id VARCHAR(20) NOT NULL,
    player_id BIGINT REFERENCES player_basic(player_id) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS cheer_songs (
    id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    team_id VARCHAR(10) NOT NULL,
    player_id BIGINT REFERENCES player_basic(player_id) ON DELETE SET NULL,
