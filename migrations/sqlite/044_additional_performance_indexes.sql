-- SQLite migration to add missing performance indexes.

-- Index for play_by_play game_id lookup
CREATE INDEX IF NOT EXISTS idx_game_play_by_play_game_id
    ON game_play_by_play (game_id);
