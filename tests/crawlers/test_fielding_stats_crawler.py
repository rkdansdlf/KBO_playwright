...
class TestBuildFieldingCrawlSummary:
    def test_valid_records(self):
        records = [
            {"player_id": 1, "player_name": "A", "team_id": "LG", "position_id": "SS", "year": 2025, "errors": 0, "games": 10},
            {"player_id": 2, "player_name": "B", "team_id": "SS", "position_id": "2B", "year": 2025, "errors": 0, "games": 10},
        ]
    ...
    def test_summary_keys(self):
        records = [{"player_id": 1, "player_name": "A", "team_id": "LG", "position_id": "C", "year": 2025, "errors": 1, "games": 10}]
